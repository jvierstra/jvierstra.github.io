...
Note: A seperate version of this file is also available (`consensus_footprints_and_motifs_hg38.bed.gz`) where column 12 is the ovleraps (≥3np) for all (not-collapsed) PWM models.
